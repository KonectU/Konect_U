...
from konectu.core.logger import AgentLogger, Loggable
...
internal_state:
  ...
  user_inputs: []
Tabs opened:
0 - [CURRENT] konectu-ai/konectu - Issues

Thoughts:
- The current screenshot shows the issues page of the GitHub repository 'konectu-ai/konectu'.
