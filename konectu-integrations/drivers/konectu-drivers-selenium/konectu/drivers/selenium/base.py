...
from konectu.core.base_driver import (
    BaseDriver,
    JS_GET_INTERACTIVES,
    JS_WAIT_DOM_IDLE,
...
from konectu.core.exceptions import (
    CannotBackException,
    NoElementException,
    AmbiguousException,
)
...
import requests
import os
from konectu.drivers.selenium.javascript import (
...
class SeleniumDriver(BaseDriver):
    ...
    def default_init_code(self) -> Any:
        ...
        from selenium.webdriver.common.keys import Keys
        from selenium.webdriver.common.action_chains import ActionChains
        from konectu.core.base_driver import JS_SETUP_GET_EVENTS
